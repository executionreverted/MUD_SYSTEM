...
import { IERC721Receiver } from "@latticexyz/world-modules/src/modules/erc721-puppet/IERC721Receiver.sol";
...
import { _balancesTableId, _metadataTableId, _tokenUriTableId, _operatorApprovalTableId, _ownersTableId, _tokenApprovalTableId } from "@latticexyz/world-modules/src/modules/erc721-puppet/utils.sol";
import { LibString } from "@latticexyz/world-modules/src/modules/erc721-puppet/libraries/LibString.sol";

contract InGameERC721 is IERC721Mintable, System, PuppetMaster {
