...
import { PuppetFactorySystem } from "@latticexyz/world-modules/src/modules/puppet/PuppetFactorySystem.sol";
import { PuppetDelegationControl } from "@latticexyz/world-modules/src/modules/puppet/PuppetDelegationControl.sol";
import { PUPPET_DELEGATION, PUPPET_FACTORY, PUPPET_TABLE_ID, NAMESPACE_ID } from "@latticexyz/world-modules/src/modules/puppet/constants.sol";
 ...
 */
contract ERC721PuppetModule is Module {
