...
library Name {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "app", name: "Name", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746261707000000000000000000000004e616d65000000000000000000000000);
