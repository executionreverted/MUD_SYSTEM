...
library Config {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "app", name: "Config", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626170700000000000000000000000436f6e66696700000000000000000000);
  ...
  function setPaused(bool paused) internal {
    ...
    StoreSwitch.setStaticField(_tableId, _keyTuple, 1, abi.encodePacked((paused)), _fieldLayout);
  }
  ...
  function _setPaused(bool paused) internal {
    ...
    StoreCore.setStaticField(_tableId, _keyTuple, 1, abi.encodePacked((paused)), _fieldLayout);
  }
   ...
   */
  function set(address adminAddress, bool paused) internal {
    bytes memory _staticData = encodeStatic(adminAddress, paused);
   ...
   * @notice Set the full data using individual values.
   */
  function _set(address adminAddress, bool paused) internal {
    bytes memory _staticData = encodeStatic(adminAddress, paused);
  ...
  function set(ConfigData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.adminAddress, _table.paused);
   ...
   */
  function decodeStatic(bytes memory _blob) internal pure returns (address adminAddress, bool paused) {
    adminAddress = (address(Bytes.getBytes20(_blob, 0)));

    paused = (_toBool(uint8(Bytes.getBytes1(_blob, 20))));
  }
  ...
  function decode(
    ...
    (_table.adminAddress, _table.paused) = decodeStatic(_staticData);
  }
   ...
   */
  function encodeStatic(address adminAddress, bool paused) internal pure returns (bytes memory) {
    return abi.encodePacked(adminAddress, paused);
  }
