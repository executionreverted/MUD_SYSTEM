...
library Item {
  ...
  /**
   * @notice Get salePrice.
   */
  function getSalePrice(uint256 id) internal view returns (uint256 salePrice) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   * @notice Get salePrice.
   */
  function _getSalePrice(uint256 id) internal view returns (uint256 salePrice) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
  ...
  /**
   * @notice Set salePrice.
   */
  function setSalePrice(uint256 id, uint256 salePrice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   * @notice Set salePrice.
   */
  function _setSalePrice(uint256 id, uint256 salePrice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   */
  function get(uint256 id) internal view returns (ItemData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   * @notice Get the full data.
   */
  function _get(uint256 id) internal view returns (ItemData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
